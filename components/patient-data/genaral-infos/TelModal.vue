          ...
          <form @submit.prevent="onUpdate">
            <ValidationProvider v-slot='{errors}' rules='required'>
              <div class="form-group">
                ...
                <b-input type="tel" class="form-control" v-model='innerField.value' :placeholder="`New ${formatName(field.name)}`"/>
              </div>
            ...
            <footer class="x-modal__footer">
              ...
              <button type="cancel" @click="$bvModal.hide('gi-tel-modal')" class="btn btn-action">Cancel</button>
            </footer>
          </form>
        </ValidationObserver>
      </main>
