  ...
  <div class="data-grid">
    <div class="data-grid-main">
      ...
      <div class="patient-data-grid">
        <div class="data-item" :key="hi.hospital_id" v-for="hi in hospitals">
          <header>
            
            <div class="title-field">
              <span class="title-key action">Hospital name:</span>
              <span class="title-value action">{{hi.hospital_name}}</span>
            </div>
            <div class="actions">
          ...
          <main>
            <div class="data-row">
              ...
              <span class="data-value">{{hi.hospital_location}}</span>
            </div>
            <div class="data-row">
              <span class="data-key">Description</span>
              <span class="data-value">{{hi.hospital_description}}</span>
            </div>
          </main>
        </div>
      </div>
    ...
    <footer class="fixed-footer">
      <button class="btn btn-footer-action" @click="onOpenCreateModal">Create Health institute</button>
    </footer>
  </div>
</template>
<script lang="ts">
